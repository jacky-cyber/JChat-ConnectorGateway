...
<script type="text/javascript">
	...
	/* var appendMsgSendByMe = function(who, message, contact, chattype) {
		...
		******************************************** 
		...
		var create = false;
		if (msgContentDiv == null) {
			msgContentDiv = createContactChatDiv("other");
			create = true;
		}
		msgContentDiv.appendChild(lineDiv);
		if (create) {
		...
		<div class="chatRight">
				...
				<div class="chat01_title">
					<ul class="talkTo">
						...
						<li id="roomInfo" style="float: right;"><img
							id="roomMemberImg"
							src="../../res/img/head/find_more_friend_addfriend_icon.png"
			...
			<div class="chat02">
				...
				<div id="input_content" class="chat02_content">
					<textarea id="talkInputId" name="talkInputId" style="resize: none;"></textarea>
				</div>
