...
public class StringUtils {
	...
	public static String getRmoteIpAddr(HttpServletRequest request) {
		...
		// 如果使用透明代理的话，得到的x-forwarded-for规则是，客户端真实
		// ip,经过的多台代理ip。如：111.111.111.11,2222.222.22.22
		if (ip != null) {
			ip = ip.split(",")[0];
		}
		return ip;
	...
	public static void main(String[] args) {
		 ...
		 * SimpleDateFormat("yyyy-MM-dd HH:SS:MM"); Calendar calendar =
		 * Calendar.getInstance(); calendar.add(Calendar.YEAR, 200);
		 * 
